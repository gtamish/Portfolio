      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 pt-20">
        <div className="max-w-3xl text-center space-y-6 sm:space-y-8">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
            <a 
              href="/projects"
              className="inline-flex items-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg bg-accent text-accent-foreground font-medium hover:opacity-90 transition-opacity text-sm sm:text-base"
            >
              View My Work
              <span>→</span>
            </a>
