...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <button
        disabled
        className="inline-flex items-center justify-center rounded-full border border-border/50 bg-background/70 p-3 backdrop-blur-xl shadow-lg transition-colors"
